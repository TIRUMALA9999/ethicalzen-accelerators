/**
 * E-commerce Support Chatbot - Secure AI Assistant
 * Protected by EthicalZen guardrails
 */
...
const CERTIFICATE_ID = process.env.ETHICALZEN_CERTIFICATE_ID || 'E-commerce Support/ecommerce/us/v1.0';
...
- NEVER share customer personal data or payment information
- Do not make unauthorized promises about refunds or compensation
...
app.listen(PORT, () => {
  console.log(`\n🛒 E-commerce Support Chatbot running on port ${PORT}`);
