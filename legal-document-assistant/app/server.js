  ...
  try {
    ...
    const gatewayResponse = await axios.post(`${GATEWAY_URL}/api/proxy`, {
      messages: [
        {
          role: 'system',
          content: 'You are a helpful legal assistant. Provide general legal information but never specific legal advice. Always recommend consulting a licensed attorney for specific cases.'
        },
        {
          role: 'user',
          content: message
